...
/**
 *https://blog.csdn.net/overmaker/article/details/2194921
 * 一个简单的用 Java Socket 编写的http 服务器应用, 演示了请求和应答的协议通信内容以及
 ...
 * 这个例子可以帮您理解 Java 的http 服务器软件是基于 J2SE 的 Socket 等软件编写的概念, 并熟悉
 *http 协议.
...
public class SimpleHttpServer implements Runnable {
                ...
                if (client != null) {
                    ...
                    try {
                        ...
                        if (resource.endsWith(".jpg")) {
                            ...
                            out.println();// 根据http 协议, 空行将结束头信息
                            out.close();
                            closeSocket(client);
                            continue;
                        } else {
                            ...
                            out.println("<h1> Hellohttp Server</h1>");
                            out.println("你好, 这是一个 Javahttp 服务器 demo 应用.<br>");
    ...
    private static void usage() {
        System.out.println("Usage: javahttpServer <port> Default port is 80.");
    }
